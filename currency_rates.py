...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Вывод курса валюты ЦБ РФ за определенную дату')
    parser.add_argument('--code', type=str, help='Код валюты в формате ISO 4217')
